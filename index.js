import{i as d}from"./assets/vendor-DVYrn7a6.js";(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const t of s)if(t.type==="childList")for(const a of t.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&n(a)}).observe(document,{childList:!0,subtree:!0});function o(s){const t={};return s.integrity&&(t.integrity=s.integrity),s.referrerPolicy&&(t.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?t.credentials="include":s.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function n(s){if(s.ep)return;s.ep=!0;const t=o(s);fetch(s.href,t)}})();const u=[{question:"Я мрію про пухнастика! Що мені потрібно зробити, щоб забрати хвостика додому?",answer:`Це чудово, що ви готові подарувати дім одному з наших підопічних! Ми дуже раді будемо вам у цьому допомогти. Процес «усиновлення» у нас простий та зрозумілий:
    ...
    <div class="accordion-item">
      ...
      <div class="accordion-content">
        <div class="faq-answer-inner">${i.answer}</div>
      </div>
    </div>
  `).join(""),e.addEventListener("click",i=>{const o=i.target.closest(".accordion-header");if(!o)return;const n=o.parentElement,s=n.classList.contains("active");document.querySelectorAll(".accordion-item").forEach(t=>{t.classList.remove("active")}),s||n.classList.add("active")}))};document.addEventListener("DOMContentLoaded",m);const r={_id:"667ad1b8e4b01a2b3c4d5e01",name:"Рекс",image:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSFx65EkJT0vcMtlDOCihKok2b8o0iIXQtCKw&s",species:"Собака",age:"3 роки",gender:"Хлопчик",behavior:"Дуже добрий та позитивний. Любить людей та інших тварин.",healthStatus:"Артрит, потребує знеболювальних препаратів. Серце в нормі для його віку.",shortDescription:"Старенький пес з артритом. Шукає тихий дім, щоб дожити віку в любові.",description:"Лорд все життя вірно служив своїм господарям, але вони померли. Він дуже спокійний та мудрий пес. Через артрит йому важко ходити по сходах. Він не потребує довгих прогулянок, лише теплого місця та люблячого серця поруч."},p=e=>new Promise((i,o)=>{setTimeout(()=>{e===r._id?i(r):o(new Error("Тваринку не знайдено"))},1e3)});function f(e){return`
    ...
    </div>`}(()=>{const e={openModalBtn:document.querySelector("[data-mobile-open]"),closeModalBtn:document.querySelector("[data-mobile-close]"),modal:document.querySelector("[data-mobile]")};e.openModalBtn.addEventListener("click",i),e.closeModalBtn.addEventListener("click",i);function i(){e.modal.classList.toggle("is-open")}e.modal.querySelectorAll('a[href*="#"]').forEach(n=>{n.addEventListener("click",()=>{e.modal.classList.remove("is-open")})})})();const c=document.getElementById("mw");document.addEventListener("click",async e=>{const i=e.target,o=i.closest("[data-modal-open]"),n=i.closest("[data-modal-close]"),s=i.classList.contains("backdrop");if(o){const t=o.dataset.id,a=o.textContent;o.disabled=!0,o.textContent="Завантаження...";try{const l=await p(t);c.innerHTML=f(l),document.body.style.overflow="hidden"}catch{d.error({title:"Помилка",message:"Тваринку не знайдено",position:"topRight"})}finally{o&&(o.disabled=!1,o.textContent=a)}return}if(n||s){const t=document.querySelector(".animal-modal"),a=document.querySelector(".backdrop");t==null||t.classList.add("exit-up"),a==null||a.style.setProperty("opacity","0"),setTimeout(()=>{c.innerHTML="",document.body.style.overflow=""},400)}i.closest("[data-modal-next]")&&(document.querySelector(".animal-modal").classList.add("exit-up"),setTimeout(()=>{c.innerHTML=v()},400))});
