import{i as d}from"./assets/vendor-DVYrn7a6.js";(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))a(t);new MutationObserver(t=>{for(const i of t)if(i.type==="childList")for(const n of i.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&a(n)}).observe(document,{childList:!0,subtree:!0});function s(t){const i={};return t.integrity&&(i.integrity=t.integrity),t.referrerPolicy&&(i.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?i.credentials="include":t.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(t){if(t.ep)return;t.ep=!0;const i=s(t);fetch(t.href,i)}})();const u=[{question:"Я мрію про пухнастика! Що мені потрібно зробити, щоб забрати хвостика додому?",answer:`Це чудово, що ви готові подарувати дім одному з наших підопічних! Ми дуже раді будемо вам у цьому допомогти. Процес «усиновлення» у нас простий та зрозумілий:
    ...
    <div class="accordion-item">
      ...
      <div class="accordion-content">
        <div class="faq-answer-inner">${o.answer}</div>
      </div>
    </div>
  `).join(""),e.addEventListener("click",o=>{const s=o.target.closest(".accordion-header");if(!s)return;const a=s.parentElement,t=a.classList.contains("active");document.querySelectorAll(".accordion-item").forEach(i=>{i.classList.remove("active")}),t||a.classList.add("active")}))};document.addEventListener("DOMContentLoaded",m);const r={_id:"667ad1b8e4b01a2b3c4d5e01",name:"Рекс",image:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSFx65EkJT0vcMtlDOCihKok2b8o0iIXQtCKw&s",species:"Собака",age:"3 роки",gender:"Хлопчик",behavior:"Дуже добрий та позитивний. Любить людей та інших тварин.",healthStatus:"Артрит, потребує знеболювальних препаратів. Серце в нормі для його віку.",shortDescription:"Старенький пес з артритом. Шукає тихий дім, щоб дожити віку в любові.",description:"Лорд все життя вірно служив своїм господарям, але вони померли. Він дуже спокійний та мудрий пес. Через артрит йому важко ходити по сходах. Він не потребує довгих прогулянок, лише теплого місця та люблячого серця поруч."},p=e=>new Promise((o,s)=>{setTimeout(()=>{e===r._id?o(r):s(new Error("Тваринку не знайдено"))},1e3)});function f(e){return`
    ...
    </div>`}(()=>{const e={openModalBtn:document.querySelector("[data-mobile-open]"),closeModalBtn:document.querySelector("[data-mobile-close]"),overlay:document.querySelector("[data-mobile-overlay]"),modal:document.querySelector("[data-mobile]")};e.openModalBtn.addEventListener("click",o),e.closeModalBtn.addEventListener("click",s),e.overlay.addEventListener("click",s),document.addEventListener("keydown",t=>{t.key==="Escape"&&e.modal.classList.contains("is-open")&&s()});function o(){e.modal.classList.add("is-open"),document.body.style.overflow="hidden"}function s(){e.modal.classList.remove("is-open"),document.body.style.overflow=""}e.modal.querySelectorAll('a[href*="#"]').forEach(t=>{t.addEventListener("click",s)})})();const c=document.getElementById("mw");document.addEventListener("click",async e=>{const o=e.target,s=o.closest("[data-modal-open]"),a=o.closest("[data-modal-close]"),t=o.classList.contains("backdrop");if(s){const i=s.dataset.id,n=s.textContent;s.disabled=!0,s.textContent="Завантаження...";try{const l=await p(i);c.innerHTML=f(l),document.body.style.overflow="hidden"}catch{d.error({title:"Помилка",message:"Тваринку не знайдено",position:"topRight"})}finally{s&&(s.disabled=!1,s.textContent=n)}return}if(a||t){const i=document.querySelector(".animal-modal"),n=document.querySelector(".backdrop");i==null||i.classList.add("exit-up"),n==null||n.style.setProperty("opacity","0"),setTimeout(()=>{c.innerHTML="",document.body.style.overflow=""},400)}o.closest("[data-modal-next]")&&(document.querySelector(".animal-modal").classList.add("exit-up"),setTimeout(()=>{c.innerHTML=v()},400))});
